...
class gnc_commanding_panel(ConfigurableCommandPanel):
    ...
    def __init__(self):
        ...
        commands = [
            ...
            ButtonSpec("StopTVC", "StopTVC"),
            ButtonSpec("CenterTVC", "CenterTVC"),
            ButtonSpec("MoveXTVCToLimitExtend", "MoveXTVCToLimitExtend"),
            ButtonSpec("MoveXTVCToLimitRetract", "MoveXTVCToLimitRetract"),
            ButtonSpec("MoveYTVCToLimitExtend", "MoveYTVCToLimitExtend"),
            ButtonSpec("MoveYTVCToLimitRetract", "MoveYTVCToLimitRetract"),
            ButtonSpec("IncrementXTVC", "IncrementXTVC"),
            ButtonSpec("DecrementXTVC", "DecrementXTVC"),
            ButtonSpec("IncrementYTVC", "IncrementYTVC"),
            ButtonSpec("DecrementYTVC", "DecrementYTVC"),
